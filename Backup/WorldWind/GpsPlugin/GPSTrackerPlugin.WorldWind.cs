	...
	public class GPSIcon : RenderableObject
	{
		...
		void ShowInfo(DrawArgs drawArgs,  Vector3 projectedPoint, float fDistance )
		{
			...
			if (m_RenderInfo.bPOI==false)
			{
				...
				{
					sInfo += "Roll: " + Convert.ToString(m_RenderInfo.fRoll) + "癨n";
				...
				{
					sInfo += "Pitch: " + Convert.ToString(m_RenderInfo.fPitch) + "癨n";
				...
				{
					sInfo += "Heading: " + Convert.ToString(m_RenderInfo.fHeading) + "癨n";
				...
				if (m_sDescriptionFrom!="")
				{
					...
					sInfo += "Bearing To " + m_sDescriptionFrom + ": " + Convert.ToString(decimal.Round(Convert.ToDecimal(dBearing),3)) + "癨n";
